...
class RentService:
    ...
    def create_rent(
        ...
        *,
        ...
        # Build the rent from the schedule definition instead of trusting client input
        # so start/end/pricing stay consistent even if the payload tries to override them.
